...
- **Stream parser**: extracts text and functionCall parts, preserves args object verbatim, emits distinct ToolCallIndex for parallel functionCalls, returns empty list for usage-only chunks and null/empty input
